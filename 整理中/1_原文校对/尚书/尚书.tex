...
此序相传为孔安国为《尚书》作传时所写，介绍《尚书》源流、内容、要义、分篇，及为之作传的缘起、过程与方法。

\begin{yuanwen}
古者伏牺氏之王天下也\footnote{text}，始画八卦，造书契\footnote{text}，以代结绳之政\footnote{text}。由是，文籍生焉\footnote{text}。
\end{yuanwen}

\begin{yuanwen}
伏牺、神农、黄帝之书，谓之《三坟》，言大道也\footnote{text}。少昊、颛顼、高辛、唐、虞之书，谓之《五典》，言常道\footnote{text}也。至于夏、商、周之书，虽设教不伦，雅诰奥义，其归一揆\footnote{text}。是故历代宝之，以为大训\footnote{text}。八卦之说，谓之《八索》，求其义也\footnote{text}。九州之志，谓之《九丘》。丘，聚也。言九州所有、土地所生、风气所宜，皆聚此书也。《春秋左氏传》曰：“楚左史倚相能读《三坟》、《五典》、《八索》、《九丘》\footnote{text}。”即谓上世帝王遗书也。
\end{yuanwen}

\begin{yuanwen}
先君孔子\footnote{text}，生于周末。睹史籍之烦文，惧览之者不一\footnote{text}，遂乃定《礼》、《乐\footnote{text}》，明旧章；删《诗》为三百篇\footnote{text}，约史记而修《春秋\footnote{text}》，赞《易》道以黜《八索》\footnote{text}，述《职方》以除《九丘》\footnote{text}。讨论《坟》、《典》\footnote{text}，断自唐、虞以下，讫于周。芟夷烦乱，剪截浮辞\footnote{text}，举其宏纲\footnote{text}，撮其机要\footnote{text}，足以垂世立教，典、谟、训、诰、誓、命之文凡百篇\footnote{text}，所以恢弘至道\footnote{text}，示人主以轨范也\footnote{text}。帝王之制，坦然明白\footnote{text}，可举而行\footnote{text}。三千之徒，并受其义\footnote{text}。
\end{yuanwen}

\begin{yuanwen}
及秦始皇灭先代典籍，焚书坑儒，天下学士逃难解散，我先人用藏其家书于屋壁\footnote{text}。汉室龙兴\footnote{text}，开设学校，旁求儒雅\footnote{text}，以阐大猷\footnote{text}。济南伏生\footnote{text}，年过九十，失其本经，口以传授，裁二十余篇\footnote{text}。以其上古之书，谓之《尚书》。百篇之义，世莫得闻。至鲁共王，好治宫室\footnote{text}，坏孔子旧宅以广其居，于壁中得先人所藏古文虞、夏、商、周之《书》及传，《论语》、《孝经》，皆科斗文字\footnote{text}。王又升孔子堂\footnote{text}，闻金石丝竹之音\footnote{text}，乃不坏宅，悉以书还孔氏。科斗书废已久，时人无能知者\footnote{text}，以所闻伏生之书考论文义\footnote{text}，定其可知者为隶古定\footnote{text}，更以竹简写之，增多伏生二十五篇。伏生又以《舜典》合于《尧典》，《益稷》合于《皋陶谟》，《盘庚》三篇合为一，《康王之诰》合于《顾命》。复出此篇，并序，凡五十九篇，为四十六卷。其余错乱摩灭\footnote{text}，弗可复知。悉上送官，藏之书府\footnote{text}，以待能者。
\end{yuanwen}

\begin{yuanwen}
承诏为五十九篇作传\footnote{text}，于是遂研精覃思\footnote{text}，博考经籍，采摭群言\footnote{text}，以立训传\footnote{text}。约文申义\footnote{text}，敷畅厥旨\footnote{text}，庶几有补于将来\footnote{text}。
\end{yuanwen}

\begin{yuanwen}
《书序\footnote{text}》，序所以为作者之意\footnote{text}。昭然义见\footnote{text}，宜相附近\footnote{text}，故引之各冠其篇首，定五十八篇。既毕，会国有巫蛊事\footnote{text}，经籍道息，用不复以闻。传之子孙，以贻后代\footnote{text}。若好古博雅君子与我同志，亦所不隐也。
\end{yuanwen}
...
\begin{yuanwen}
昔在帝尧，聪明文思\footnote{text}，光宅天下\footnote{text}，将逊于位\footnote{text}，让于虞舜，作《尧典》\footnote{text}。
\end{yuanwen}
...
帝尧曰放勋\footnote{text}，钦、明、文、思、安安\footnote{text}，允恭克让\footnote{text}。光被四表\footnote{text}，格于上下\footnote{text}。克明俊德\footnote{text}，以亲九族\footnote{text}。九族既睦\footnote{text}，平章百姓\footnote{text}。百姓昭明，协和万邦\footnote{text}。黎民于变时雍\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
乃命羲、和钦若昊天\footnote{text}，历象日月星辰\footnote{text}，敬授人时\footnote{text}。分命羲仲宅嵎夷\footnote{text}，曰旸谷\footnote{text}，寅宾出日\footnote{text}，平秩东作\footnote{text}。日中、星鸟\footnote{text}，以殷仲春\footnote{text}。厥民析\footnote{text}，鸟兽孳尾\footnote{text}。申命羲叔宅南交\footnote{text}，曰明都，平秩南讹\footnote{text}，敬致\footnote{text}。日永、星火\footnote{text}，以正仲夏\footnote{text}。厥民因\footnote{text}，鸟兽希革\footnote{text}。分命和仲宅西\footnote{text}，曰昧谷\footnote{text}，寅饯纳日\footnote{text}，平秩西成\footnote{text}。宵中、星虚\footnote{text}，以殷仲秋\footnote{text}。厥民夷\footnote{text}，鸟兽毛毨\footnote{text}。申命和叔宅朔方\footnote{text}，曰幽都\footnote{text}，平在朔易\footnote{text}。日短、星昴\footnote{text}，以正仲冬。厥民隩\footnote{text}，鸟兽氄毛\footnote{text}。

帝曰：“咨\footnote{text}！汝羲暨和\footnote{text}，期三百有六旬有六日\footnote{text}，以闰月定四时成岁\footnote{text}。允厘百工\footnote{text}，庶绩咸熙\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“畴咨\footnote{text}？若时登庸\footnote{text}？”

放齐\footnote{text}曰：“胤子朱启明\footnote{text}。”

帝曰：“吁\footnote{text}！嚚讼\footnote{text}，可乎？”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“畴咨？若予采\footnote{text}？”

驩兜\footnote{text}曰：“都\footnote{text}！共工方鸠僝功\footnote{text}。”

帝曰：“吁！静言\footnote{text}，庸违\footnote{text}。象恭滔天\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“咨！四岳\footnote{text}，汤汤洪水方割\footnote{text}，荡荡怀山襄陵\footnote{text}，浩浩滔天\footnote{text}，下民其咨\footnote{text}，有能俾乂\footnote{text}？”

佥\footnote{text}曰：“於\footnote{text}，鲧哉\footnote{text}！”

帝曰：“吁！咈哉\footnote{text}！方命圮族\footnote{text}。”

岳曰：“异\footnote{text}哉！试可乃已\footnote{text}。”

帝曰，“往，钦哉\footnote{text}！”

九载，绩用弗成\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“咨！四岳，朕在位七十载，汝能庸命\footnote{text}，巽朕位\footnote{text}？”

岳曰：“否德\footnote{text}，忝帝位\footnote{text}。”

曰：“明明扬侧陋\footnote{text}。”

师锡帝\footnote{text}曰：“有鳏在下\footnote{text}，曰虞舜。”

帝曰：“俞\footnote{text}！予闻。如何？”

岳曰：“瞽子\footnote{text}。父顽、母嚚、象傲\footnote{text}，克谐以孝\footnote{text}，蒸蒸乂\footnote{text}，不格奸\footnote{text}。”

帝曰：“我其试哉！女于时\footnote{text}，观厥刑于二女\footnote{text}。”

厘降二女于妫汭\footnote{text}，嫔于虞。
...
\begin{yuanwen}
虞舜侧微\footnote{text}，尧闻之聪明\footnote{text}，将使嗣位\footnote{text}，历试诸难\footnote{text}，作《舜典》。
\end{yuanwen}
...
帝舜曰重华，协于帝\footnote{text}。浚哲文明\footnote{text}，温恭允塞\footnote{text}。玄德升闻\footnote{text}，乃命以位\footnote{text}。

慎徽生五典\footnote{text}，五典克从\footnote{text}；纳于百揆\footnote{text}，百揆时叙\footnote{text}；宾于四门\footnote{text}，四门穆穆\footnote{text}；纳于大麓\footnote{text}，烈风雷雨弗迷\footnote{text}。

帝曰：“格\footnote{text}，汝舜！询事考言\footnote{text}，乃言厎可绩\footnote{text}。三载，汝陟帝位\footnote{text}！”

舜让于德，弗嗣\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
正月上日\footnote{text}，受终于文祖\footnote{text}。在璇玑玉衡\footnote{text}，以齐七政\footnote{text}。肆类于上帝\footnote{text}，禋于六宗\footnote{text}，望于山川\footnote{text}，遍于群神。辑五瑞\footnote{text}。既月乃日\footnote{text}，觐四岳群牧\footnote{text}，班瑞于群后\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
岁二月\footnote{text}，东巡守\footnote{text}，至于岱宗\footnote{text}，柴\footnote{text}。望秩于山川\footnote{text}，肆觐东后\footnote{text}。协时月\footnote{text}，正日\footnote{text}，同律度量衡\footnote{text}。修五礼、五玉\footnote{text}。三帛、二生、一死贽\footnote{text}，如五器\footnote{text}。卒，乃复\footnote{text}。

五月，南巡守，至于南岳\footnote{text}，如岱礼。

八月，西巡守，至于西岳\footnote{text}，如初。

十有一月，朔巡守\footnote{text}，至于北岳\footnote{text}，如西礼。

归，格于艺祖\footnote{text}，用特\footnote{text}。

五载一巡守，群后四朝。敷奏以言\footnote{text}，明试以功\footnote{text}，车服以庸\footnote{text}。
\end{yuanwen}
...
五月，舜又来到南方巡视，到达南岳，举行了和祭祀泰山一样的祭祀礼。

八月，舜到西方巡视，在华山举行了和泰山一样的祭祀礼。

十一月初一，舜到北方巡视，所行的礼节同在西岳一样。
...
\begin{yuanwen}
肇十有二州\footnote{text}，封十有二山\footnote{text}，浚川\footnote{text}。

象以典刑\footnote{text}，流宥五刑\footnote{text}，鞭作官刑\footnote{text}，扑作教刑\footnote{text}，金作赎刑\footnote{text}。眚灾肆\footnote{text}赦，怙终贼刑\footnote{text}。

钦哉，钦哉，惟刑之恤\footnote{text}哉！

流共工于幽洲\footnote{text}，放驩兜于崇山\footnote{text}，窜三苗于三危\footnote{text}，殛鲧于羽山\footnote{text}，四罪而天下咸服\footnote{text}。
\end{yuanwen}

舜划定十二州的疆界，在十二州的名山上封土为坛举行祭祀，又疏通了河道。

舜又在器物上刻画五种常用的刑罚。用流放的办法宽恕犯了五刑的罪人，用鞭打作为官的刑罚，用木条打作为学校的刑罚，用铜作为赎罪的刑罚。因过失犯罪，就赦免他；有所依仗不知悔改，就要施加刑罚。
...
\begin{yuanwen}
二十有八载，帝乃殂落\footnote{text}，百姓如丧考妣\footnote{text}。三载，四海遏密八音\footnote{text}。月正元日\footnote{text}，舜格于文祖，询于四岳\footnote{text}，辟四门，明四目\footnote{text}，达四聪\footnote{text}。
\end{yuanwen}

舜辅助尧帝二十八年后，尧帝逝世了。人们好象死了父母一样地悲痛，三年间，全国上下停止了乐音。明年正月的一个吉日，舜到了尧的太庙，与四方诸侯君长谋划政事，打开明堂四门宣布政教，使四方见得明白，听得通彻。

\begin{yuanwen}
咨十有二牧\footnote{text}曰:“食哉！惟时柔远能迩\footnote{text}。惇德允元\footnote{text}，而难任人\footnote{text}，蛮夷率服\footnote{text}。”

舜曰：“咨！四岳，有能奋庸熙帝之载\footnote{text}，使宅百揆亮采\footnote{text}。惠畴\footnote{text}？”

佥曰：“伯禹作司空\footnote{text}。”

帝曰：“俞\footnote{text}！咨，禹，汝平水土，惟时懋哉\footnote{text}！”

禹拜稽首，让于稷、契暨皋陶\footnote{text}。

帝曰：“俞！汝往哉！”

帝曰：“弃，黎民阻饥\footnote{text}，汝后稷\footnote{text}，播时百谷\footnote{text}。”

帝曰：“契，百姓不亲，五品不逊\footnote{text}。汝作司徒\footnote{text}，敬敷五教\footnote{text}，在宽\footnote{text}。”

帝曰：“皋陶，蛮夷猾夏\footnote{text}，寇贼奸宄\footnote{text}。汝作士\footnote{text}，五刑有服\footnote{text}，五服三就\footnote{text}。五流有宅\footnote{text}，五宅三居\footnote{text}。惟明克允\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“畴若予工\footnote{text}？”

佥曰：“垂哉\footnote{text}！”

帝曰：“俞！咨，垂，汝共工\footnote{text}。”

垂拜稽首，让于殳斨暨伯与\footnote{text}。

帝曰：“俞，往哉！汝谐\footnote{text}。”

帝曰：“畴若予上下草木鸟兽\footnote{text}？”

佥曰：“益\footnote{text}哉！”

帝曰：“俞！咨，益，汝作朕虞\footnote{text}。”

益拜稽首，让于朱虎、熊罴\footnote{text}。

帝曰：“俞，往哉！汝谐。”

帝曰：“咨！四岳，有能典朕三礼\footnote{text}？”

佥曰：“伯夷\footnote{text}！”

帝曰：“俞！咨，伯，汝作秩宗\footnote{text}。夙夜惟寅\footnote{text}，直哉惟清\footnote{text}。”

伯拜稽首，让于夔、龙\footnote{text}。

帝曰：“俞！往，钦哉\footnote{text}！”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“夔，命汝典乐，教胄子\footnote{text}。直而温\footnote{text}，宽而栗\footnote{text}，刚而无虐，简而无傲\footnote{text}。诗言志，歌永言\footnote{text}，声依永\footnote{text}，律和声\footnote{text}。八音克谐\footnote{text}，无相夺伦\footnote{text}，神人以和\footnote{text}。”

夔曰：“於\footnote{text}！予击石拊石\footnote{text}，百兽率舞\footnote{text}。”

帝曰：“龙，朕塈谗说殄行\footnote{text}，震惊联师\footnote{text}。命汝作纳言\footnote{text}，夙夜出纳朕命\footnote{text}，惟允\footnote{text}！”

帝曰：“咨！汝二十有二人\footnote{text}，钦哉！惟时亮天功\footnote{text}。”

三载考绩\footnote{text}。三考，黜陟幽明\footnote{text}，庶绩咸熙\footnote{text}。分北三苗\footnote{text}。 
\end{yuanwen}
...
\begin{yuanwen}
舜生三十征\footnote{text}，庸三十\footnote{text}，在位五十载，陟方乃死\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
帝厘下土\footnote{text}，方设居方\footnote{text}，别生分类\footnote{text}。作《汩作》、《九共》九篇、《槁饫》。
\end{yuanwen}
...
\begin{yuanwen}
皋陶矢厥谟\footnote{text}，禹成厥功，帝舜申\footnote{text}之。作《大禹、皋陶谟》、《益稷》\footnote{text}。
\end{yuanwen}
...
大禹曰：“文命敷于四海\footnote{text}，祗承于帝\footnote{text}。曰，‘后克艰厥后\footnote{text}，臣克艰厥臣，政乃乂\footnote{text}，黎民敏德\footnote{text}。’”	
\end{yuanwen}

传说：若考古时候的大禹，又名文命，他的功德广布到了四海。他曾经接受帝舜的征询，发表自己的见解道：“为君的能知道为君的艰难，为臣的能知道为臣的艰难，那么，政事就能治理好，人民也就会迅速修德了。”

\begin{yuanwen}
帝曰：“俞\footnote{text}！允若兹\footnote{text}，嘉言罔攸伏\footnote{text}，野无遗贤\footnote{text}，万邦咸宁\footnote{text}。稽于众\footnote{text}，舍己从人，不虐无告\footnote{text}，不废困穷\footnote{text}，惟帝时克\footnote{text}。”
\end{yuanwen}

帝舜道：“这话不错。确实像这样，那么，好主意就不会被搁置不用，贤才就不会被遗弃在田野之间，万邦都会太平。凡事都考察群众的意见，常常放弃自己不正确的意见，听从别人正确的意见；为政不虐待无告的穷人，用人不忽视卑贱的贤才，这只有帝尧的时候才能做到。”

\begin{yuanwen}
益\footnote{text}曰：“都\footnote{text}！帝德广运\footnote{text}，乃圣乃神\footnote{text}，乃武乃文\footnote{text}。皇天眷命\footnote{text}，奄有四海\footnote{text}，为天下君。”

禹曰：“惠迪吉\footnote{text}，从逆凶，惟影响\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
益曰：“吁\footnote{text}！戒哉！儆戒无虞\footnote{text}。罔失法度\footnote{text}，罔游于逸\footnote{text}，罔淫于乐\footnote{text}。任贤勿贰，去邪勿疑，疑谋勿成\footnote{text}，百志惟熙\footnote{text}。罔违道以干百姓之誉\footnote{text}，罔咈百姓以从己之欲\footnote{text}。无怠无荒\footnote{text}，四夷来王\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
禹曰：“於\footnote{text}！帝念哉\footnote{text}！德惟善政\footnote{text}，政在养民。水、火、金、木、土、谷惟修\footnote{text}；正德、利用、厚生惟和\footnote{text}。九功惟叙\footnote{text}，九叙惟歌。戒之用休\footnote{text}，董之用威\footnote{text}，劝之以九歌\footnote{text}，俾勿坏\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“俞！地平天成\footnote{text}，六府三事允治，万世永赖，时乃功\footnote{text}。”
\end{yuanwen}

帝舜道：“讲得对！现在水土治平，万物得以成长，六府三事确实治理得很有秩序，万世以后都要仰赖那时你的大功啊！”

\begin{yuanwen}
帝曰：“格\footnote{text}，汝禹！朕宅帝位三十有三载\footnote{text}，耄期\footnote{text}，倦于勤\footnote{text}。汝惟不怠，总朕师\footnote{text}。”

禹曰：“朕德罔克\footnote{text}，民不依。皋陶迈种德\footnote{text}，德乃降，黎民怀之\footnote{text}。帝念哉！念兹在兹\footnote{text}，释兹在兹\footnote{text}，名言兹在兹\footnote{text}，允出兹在兹\footnote{text}，惟帝念功。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“皋陶，惟兹臣庶\footnote{text}，罔或干予正\footnote{text}。汝作士\footnote{text}，明于五刑\footnote{text}，以弼五教\footnote{text}。期于予治\footnote{text}，刑期于无刑，民协于中\footnote{text}。时乃功，懋哉\footnote{text}。”

皋陶曰：“帝德罔愆\footnote{text}，临下以简，御众以宽\footnote{text}；罚弗及嗣\footnote{text}，赏延于世\footnote{text}。宥过无大\footnote{text}，刑故无小\footnote{text}；罪疑惟轻\footnote{text}，功疑惟重\footnote{text}；与其杀不辜\footnote{text}，宁失不经\footnote{text}；好生之德，洽于民心\footnote{text}，兹用不犯于有司\footnote{text}。”

帝曰：“俾予从欲以治\footnote{text}，四方风动\footnote{text}，惟乃之休\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“来，禹！降水儆予\footnote{text}，成允成功\footnote{text}，惟汝贤\footnote{text}。克勤于邦\footnote{text}，克俭于家，不自满假\footnote{text}，惟汝贤。汝惟不矜\footnote{text}，天下莫与汝争能。汝惟不伐\footnote{text}，天下莫与汝争功。予懋乃德\footnote{text}，嘉乃丕绩\footnote{text}，天之历数在汝躬\footnote{text}，汝终陟元后\footnote{text}。人心惟危，道心惟微\footnote{text}，惟精惟一\footnote{text}，允执厥中\footnote{text}。无稽之言勿听\footnote{text}，弗询之谋勿庸。可爱非君\footnote{text}？可畏非民？众非元后何戴\footnote{text}？后非众罔与守邦？钦哉\footnote{text}！慎乃有位\footnote{text}，敬修其可愿\footnote{text}。四海困穷，天禄永终\footnote{text}。惟口出好兴戎\footnote{text}，朕言不再\footnote{text}。”

禹曰：“枚卜功臣\footnote{text}，惟吉之从。”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“禹，官占惟先蔽志\footnote{text}，昆命于元龟\footnote{text}。朕志先定，询谋佥同\footnote{text}，鬼神其依\footnote{text}，龟筮协从\footnote{text}，卜不习吉。”

禹拜稽首，固辞。

帝曰：“毋！惟汝谐\footnote{text}。”

正月朔旦\footnote{text}，受命于神宗\footnote{text}，率百官若帝之初\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“咨\footnote{text}！禹，惟时有苗弗率\footnote{text}，汝徂征\footnote{text}。”

禹乃会群后\footnote{text}，誓于师曰\footnote{text}：“济济有众\footnote{text}，咸听朕命。蠢兹有苗\footnote{text}，昏迷不恭\footnote{text}，侮慢自贤\footnote{text}，反道败德\footnote{text}。君子在野，小人在位，民弃不保\footnote{text}，天降之咎\footnote{text}，肆予以尔众士\footnote{text}，奉辞伐罪\footnote{text}。尔尚一乃心力\footnote{text}，其克有勋\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
三旬，苗民逆命\footnote{text}。益赞于禹曰\footnote{text}：“惟德动天\footnote{text}，无远弗届\footnote{text}。满招损\footnote{text}，谦受益，时乃天道\footnote{text}。帝初于历山\footnote{text}，往于田，日号泣于旻天\footnote{text}，于父母，负罪引慝祗载\footnote{text}。见瞽叟\footnote{text}，夔夔斋栗\footnote{text}，瞽亦允若\footnote{text}。至諴感神\footnote{text}，矧兹有苗\footnote{text}？”

禹拜昌言曰：“俞！”

班师振旅\footnote{text}。

帝乃诞敷文德\footnote{text}，舞干羽于两阶\footnote{text}。七旬，有苗格\footnote{text}。
\end{yuanwen}
...
皋陶曰：“允迪厥德\footnote{text}，谟明弼谐\footnote{text}。”

禹曰：“俞\footnote{text}，如何？”

皋陶曰：“都！慎厥身，修思永\footnote{text}。惇叙九族\footnote{text}，庶明励翼\footnote{text}，迩可远\footnote{text}，在兹。”
...
皋陶说：“啊！要谨慎其身，坚持不懈地努力提升自身的修养。要使近亲宽厚顺从，使贤人勉力辅佐，由近及远，完全在于从这里做起。”

禹听了这番精当的言论，拜谢说：“对呀！”

\begin{yuanwen}
皋陶曰：“都！在知人\footnote{text}，在安民。”

禹曰：“吁\footnote{text}！咸若时\footnote{text}，惟帝其难之\footnote{text}。知人则哲\footnote{text}，能官人\footnote{text}。安民则惠\footnote{text}，黎民怀之\footnote{text}。能哲而惠，何忧乎驩兜\footnote{text}？何迁乎有苗\footnote{text}？何畏乎巧言令色孔壬\footnote{text}？”
\end{yuanwen}
...
\begin{yuanwen}
皋陶曰：“都！亦行有九德\footnote{text}，亦言其人有德，乃言曰，载采采\footnote{text}。”
...
\begin{yuanwen}
皋陶曰：“宽而栗\footnote{text}，柔而立\footnote{text}，愿而恭\footnote{text}，乱而敬\footnote{text}，扰而毅\footnote{text}，直而温\footnote{text}，简而廉\footnote{text}，刚而塞\footnote{text}，强而义\footnote{text}。彰厥有常，吉哉！日宣三德\footnote{text}，夙夜浚明，有家\footnote{text}；日严祗敬六德\footnote{text}，亮采\footnote{text}，有邦翕受敷施\footnote{text}。九德咸事\footnote{text}，俊乂在官\footnote{text}。百僚师师\footnote{text}，百工惟时\footnote{text}，抚于五辰\footnote{text}，庶绩其凝\footnote{text}。无教逸欲\footnote{text}，有邦兢兢业业\footnote{text}。一日二日万几\footnote{text}。无旷庶官\footnote{text}。天工\footnote{text}，人其代之。天叙有典\footnote{text}，敕我五典五惇哉\footnote{text}！天秩有礼\footnote{text}，自我五礼有庸哉\footnote{text}！同寅协恭和衷哉\footnote{text}！天命有德\footnote{text}，五服五章哉\footnote{text}！天讨有罪\footnote{text}，五刑五用哉\footnote{text}！政事懋哉懋哉\footnote{text}！天聪明\footnote{text}，自我民聪明。天明畏\footnote{text}，自我民明威。达于上下\footnote{text}，敬哉有土\footnote{text}！”
\end{yuanwen}
...
\begin{yuanwen}
皋陶曰：“朕言惠可厎行\footnote{text}？”

禹曰：“俞\footnote{text}！乃言厎可绩\footnote{text}。”

皋陶曰：“予未有知，思曰赞赞襄哉\footnote{text}！”
\end{yuanwen}
...
\begin{yuanwen}
帝曰：“来，禹！汝亦昌言\footnote{text}。”

禹拜曰：“都\footnote{text}！帝，予何言？予思日孜孜\footnote{text}。”

皋陶曰：“吁\footnote{text}！如何？”

禹曰：“洪水滔天，浩浩怀山襄陵\footnote{text}，下民昏垫\footnote{text}。予乘四载\footnote{text}，随山刊木\footnote{text}，暨益奏庶鲜食\footnote{text}。予决九川距四海\footnote{text}，浚畎浍距川\footnote{text}。暨稷播\footnote{text}，奏庶艰食鲜食\footnote{text}。懋迁有无化居\footnote{text}。烝民乃粒\footnote{text}，万邦作乂\footnote{text}。”

皋陶曰：“俞！师汝昌言\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
禹曰：“都！帝，慎乃在位\footnote{text}。”

帝曰：“俞！”

禹曰：“安汝止\footnote{text}，惟几惟康\footnote{text}。其弼直\footnote{text}，惟动丕应\footnote{text}。徯志以昭受上帝\footnote{text}，天其申命用休\footnote{text}。”

帝曰：“吁！臣哉邻哉\footnote{text}！邻哉臣哉！”
...
\begin{yuanwen}
帝曰：“臣作朕股肱耳目\footnote{text}。予欲左右有民\footnote{text}，汝翼\footnote{text}。予欲宣力四方\footnote{text}，汝为\footnote{text}。予欲观古人之象\footnote{text}，日、月、星辰、山、龙、华虫\footnote{text}，作会\footnote{text}；宗彝\footnote{text}、藻\footnote{text}、火\footnote{text}、粉米\footnote{text}、黼、黻\footnote{text}，絺绣\footnote{text}，以五采彰施于五色\footnote{text}，作服，汝明\footnote{text}。予欲闻六律五声八音\footnote{text}，在治忽\footnote{text}，以出纳五言\footnote{text}，汝听。予违，汝弼\footnote{text}。汝无面从\footnote{text}，退有后言\footnote{text}。钦四邻\footnote{text}！庶顽谗说\footnote{text}，若不在时\footnote{text}，侯以明之\footnote{text}，挞以记之\footnote{text}，书用识哉\footnote{text}，欲并生哉\footnote{text}！工以纳言\footnote{text}，时而扬之\footnote{text}，格则承之庸之\footnote{text}，否则威之\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
禹曰：“俞哉！帝：光天之下\footnote{text}，至于海隅苍生\footnote{text}，万邦黎献\footnote{text}，共惟帝臣\footnote{text}，惟帝时举\footnote{text}。敷纳以言\footnote{text}，明庶以功\footnote{text}，车服以庸\footnote{text}。谁敢不让，敢不敬应\footnote{text}？帝不时敷\footnote{text}，同，日奏\footnote{text}，罔功\footnote{text}。无若丹朱傲\footnote{text}，惟慢游是好\footnote{text}，傲虐是作\footnote{text}。罔昼夜頟頟\footnote{text}，罔水行舟\footnote{text}。朋淫于家\footnote{text}，用殄厥世\footnote{text}。予创若时\footnote{text}，娶于涂山\footnote{text}，辛壬癸甲\footnote{text}。启呱呱而泣\footnote{text}，予弗子\footnote{text}，惟荒度土功\footnote{text}。弼成五服\footnote{text}，至于五千\footnote{text}。州十有二师\footnote{text}，外薄四海\footnote{text}，咸建五长\footnote{text}，各迪有功\footnote{text}，苗顽弗即工\footnote{text}，帝其念哉\footnote{text}！”

帝曰：“迪朕德\footnote{text}，时乃功\footnote{text}，惟叙\footnote{text}。皋陶方祗厥叙\footnote{text}，方施象刑\footnote{text}，惟明\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
夔曰\footnote{text}：“戛击鸣球\footnote{text}、搏拊琴、瑟\footnote{text}，以咏\footnote{text}。”

祖考来格\footnote{text}，虞宾在位\footnote{text}，群后德让\footnote{text}。下管鼗鼓\footnote{text}，合止柷敔\footnote{text}，笙镛以间\footnote{text}。鸟兽跄跄\footnote{text}；《箫韶》九成\footnote{text}，凤皇来仪\footnote{text}。

夔曰：“於\footnote{text}！予击石拊石\footnote{text}，百兽率舞\footnote{text}，庶尹允谐\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
帝庸作歌\footnote{text}。曰：“敕天之命\footnote{text}，惟时惟几\footnote{text}。”乃歌曰：“股肱喜哉\footnote{text}！元首起哉\footnote{text}！百工熙哉\footnote{text}！”

皋陶拜手稽首扬言曰\footnote{text}：“念哉！率作兴事\footnote{text}，慎乃宪\footnote{text}，钦哉！屡省乃成\footnote{text}，钦哉！”

乃赓载歌曰\footnote{text}：“元首明哉\footnote{text}，股肱良哉，庶事康哉\footnote{text}！”

又歌曰：“元首丛脞哉\footnote{text}！股肱惰哉，万事堕哉\footnote{text}！”
...
\begin{yuanwen}
禹别九州\footnote{text}，随山浚川\footnote{text}，任土作贡\footnote{text}。

禹敷土\footnote{text}，随山刊木，奠高山大川\footnote{text}。
\end{yuanwen}
...
既载壶口\footnote{text}，治梁及岐\footnote{text}。既修太原\footnote{text}，至于岳阳\footnote{text}；覃怀厎绩\footnote{text}，至于衡漳\footnote{text}。厥土惟白壤\footnote{text}，厥赋惟上上\footnote{text}，错\footnote{text}。厥田惟中中\footnote{text}。恒、卫既从\footnote{text}，大陆既作\footnote{text}。岛夷皮服\footnote{text}，夹右碣石入于河\footnote{text}。
\end{yuanwen}

冀州：

从壶口开始施工后，就治理梁山和它的支脉。太原治理好了以后，又治理到太岳山的南面。覃怀一带的治理取得了成效，又到了横流入河的漳水。这州的土是白壤，赋税是第一等，也夹杂着第二等，这里的田地是第五等。恒水、卫水已经顺着河道而流，大陆泽也已治理了。岛夷的人用皮服来进贡，先接近右边的碣石山，再进入黄河。

\begin{yuanwen}
济、河惟兖州\footnote{text}：

九河既道\footnote{text}，雷夏既泽\footnote{text}，灉、沮会同\footnote{text}。桑土既蚕\footnote{text}，是降丘宅土\footnote{text}。厥土黑坟\footnote{text}，厥草惟繇\footnote{text}，厥木惟条\footnote{text}。厥田惟中下，厥赋贞\footnote{text}，作十有三载，乃同\footnote{text}。厥贡漆丝，厥篚织文\footnote{text}。浮于济、漯\footnote{text}，达于河。
\end{yuanwen}

济水与黄河之间是兖州：黄河下游的九条支流疏通了，雷夏也已经成了湖泽，澭水和沮水会合流进了雷夏泽。栽种桑树的地方都已经养蚕，于是人们从山丘上搬下来住在平地上。这里的土质又黑又肥，这里的草是茂盛的，这里的树是修长的。这里的田地是第六等，赋税是第九等，耕作了十三年才与其它八个州相同。这里的贡物是漆和丝，还有用竹筐装着的彩绸。进贡的物品从济水、漯水乘船到黄河。济水与黄河之间是兖州：黄河下游的九条支流疏通了，雷夏也已经成了湖泽，澭水和沮水会合流进了雷夏泽。栽种桑树的地方都已经养蚕，于是人们从山丘上搬下来住在平地上。这里的土质又黑又肥，这里的草是茂盛的，这里的树是修长的。这里的田地是第六等，赋税是第九等，耕作了十三年才与其它八个州相同。这里的贡物是漆和丝，还有用竹筐装着的彩绸。进贡的物品从济水、漯水乘船到黄河。

\begin{yuanwen}
海、岱惟青州\footnote{text}：

嵎夷既略\footnote{text}，潍、淄其道\footnote{text}。厥土白坟，海滨广斥\footnote{text}。厥田惟上下，厥赋中上。厥贡盐絺\footnote{text}，海物惟错\footnote{text}。岱畎丝、枲、铅、松、怪石\footnote{text}。莱夷作牧\footnote{text}。厥篚檿丝\footnote{text}。浮于汶，达于济。
\end{yuanwen}

渤海和泰山之间是青州：

嵎夷治理好以后，潍水和淄水也已经疏通了。这里的土又白又肥，海边有一片广大的盐碱地。这里的田是第三等，赋税是第四等。这里进贡的物品是盐和细葛布，海产品多种多样。还有泰山谷的丝、大麻、锡、松和奇特的石头。莱夷一带可以放牧。这里进贡的物品是用筐装的柞蚕丝。进贡的船只从汶水通到济水。

\begin{yuanwen}
海、岱及淮惟徐州\footnote{text}：

淮、沂其乂\footnote{text}，蒙、羽其艺\footnote{text}，大野既猪\footnote{text}，东原厎平\footnote{text}。厥土赤埴坟\footnote{text}，草木渐包\footnote{text}。厥田惟上中，厥赋中中。厥贡惟土五色\footnote{text}，羽畎夏翟\footnote{text}，峄阳孤桐\footnote{text}，泗滨浮磬\footnote{text}，淮夷蠙珠暨鱼\footnote{text}。厥篚玄纤、缟\footnote{text}。浮于淮、泗，达于河。
\end{yuanwen}

黄海、泰山及淮河之间是徐州：

淮河、沂水治理好以后，蒙山、羽山一带已经可以种植了，大野泽已经停聚着深水，东原地方也获得治理。这里的土是红色的，又粘又肥，草木不断滋长而丛生。这里的田是第二等，赋税是第五等。进贡的物品是五色土，羽山山谷的大山鸡，峄山南面的特产桐木，泗水边上的可以做磬的石头，淮夷之地的蚌珠和鱼。还有用筐子装着的黑色的细绸和白色的绢。进贡的船只从淮河、泗水，到达与济水相通的荷泽。

\begin{yuanwen}
淮、海惟扬州\footnote{text}：

彭蠡既猪\footnote{text}，阳鸟攸居\footnote{text}。三江既入\footnote{text}，震泽厎定\footnote{text}。筿簜既敷\footnote{text}，厥草惟夭\footnote{text}，厥木惟乔\footnote{text}。厥土惟涂泥\footnote{text}。厥田唯下下，厥赋下上，上错。厥贡惟金三品\footnote{text}，瑶、琨\footnote{text}、筿、簜、齿、革、羽、毛惟木\footnote{text}。岛夷卉服\footnote{text}。厥篚织贝\footnote{text}，厥包桔柚\footnote{text}，锡贡\footnote{text}。沿于江、海，达于淮、泗。
\end{yuanwen}

淮河与黄海之间是扬州：

彭蠡泽已经汇集了深水，南方各岛可以安居。三条江水已经流入大海，震泽也获得了安定小竹和大竹已经遍布各地，这里的草很茂盛，这里的树很高大。这里的土是潮湿的泥。田是第九等，赋是第七等，杂出第六等。进贡的物品是金、银、铜、美玉、美石、小竹、大竹、象牙、犀皮、鸟的羽毛、旄牛尾和木材。东南沿海各岛的人穿着草编的衣服。这一带把贝锦放在筐子里，把橘柚包起来作为贡品。这些贡品沿着长江、黄海到达淮河、泗水。

\begin{yuanwen}
荆及衡阳惟荆州\footnote{text}：

江、汉朝宗于海\footnote{text}，九江孔殷\footnote{text}，沱、潜既道\footnote{text}，云土、梦作乂\footnote{text}。厥土惟涂泥，厥田惟下中，厥赋上下。厥贡羽、毛、齿、革惟金三品\footnote{text}，杶、干、栝\footnote{text}、柏，砺、砥、砮、丹，惟箘簵、楛\footnote{text}，三邦厎贡厥名\footnote{text}。包匦菁茅\footnote{text}，厥篚玄纁玑组\footnote{text}，九江纳锡大龟\footnote{text}。浮于江、沱、潜、汉，逾于洛\footnote{text}，至于南河\footnote{text}。
\end{yuanwen}

荆山与衡山的南面是荆州：

长江、汉水象诸侯朝见天子一样奔向海洋，洞庭湖的水系大定了，沱水、潜水疏通以后，云梦泽一带可以耕作了。这里的土是潮湿的泥，这里的田是第八等，赋是第三等。这里的贡物是羽毛、旄牛尾、象牙、犀皮和金、银、铜，椿树、柘树、桧树、柏树，粗磨石、细磨石、造箭镞的石头、丹砂和细长的竹子、楛木。三个诸侯国进贡他们的名产，包裹好了的杨梅、菁茅，装在筐子里的彩色丝绸和一串串的珍珠。九江进贡大龟。这些贡品从长江、沱水、潜水、汉水到达汉水上游，改走陆路到洛水，再到南河。

\begin{yuanwen}
荆、河惟豫州：

伊、洛、瀍、涧既入于河\footnote{text}，荥波既猪\footnote{text}。导菏泽\footnote{text}，被孟猪\footnote{text}。厥土惟壤，下土坟垆\footnote{text}。厥田惟中上，厥赋错上中。厥贡漆、枲，絺、紵\footnote{text}，厥篚纤、纩\footnote{text}，锡贡磬错\footnote{text}。浮于洛，达于河\footnote{text}。
\end{yuanwen}

荆山、黄河之间是豫州：

伊水、瀍水和涧水都已流入洛水，又流入黄河，荥波泽已经停聚了大量的积水。疏通了菏泽，并在孟猪泽筑起了堤防。这里的土是柔软的壤土，低地的土是肥沃的黑色硬土。这里的田是第四等，赋税是第二等，杂出第一等。这里的贡物是漆、麻、细葛、纻麻，用篚装的绸和细绵，又进贡治玉磬的石头。进贡的船只从洛水到达黄河。

\begin{yuanwen}
华阳、黑水惟梁州\footnote{text}：

岷、嶓既艺\footnote{text}，沱、潜既道\footnote{text}。蔡、蒙旅平\footnote{text}，和夷厎绩\footnote{text}。厥土青黎\footnote{text}，厥田惟下上，厥赋下中，三错\footnote{text}。厥贡璆、铁、银、镂、砮\footnote{text}、磬、熊、罴、狐、狸、织皮\footnote{text}，西倾因桓是来\footnote{text}，浮于潜\footnote{text}，逾于沔\footnote{text}，入于渭\footnote{text}，乱于河\footnote{text}。
\end{yuanwen}

华山南部到怒江之间是梁州：

岷山、嶓冢山治理以后，沱水、潜水也已经疏通了。峨嵋山、蒙山治理后，和夷一带也取得了治理的功效。这里的土是疏松的黑土，这里的田是第七等，赋税是第八等，还杂出第七等和第九等。这里的贡物是美玉、铁、银、刚铁、作箭镞的石头、磬、熊、马熊、狐狸、野猫。织皮和西倾山的贡物沿着桓水而来。进贡的船只行于潜水，然后离船上岸陆行，再进入沔水，进到渭水，最后横渡渭水到达黄河。

\begin{yuanwen}
黑水、西河惟雍州\footnote{text}：

弱水既西\footnote{text}，泾属渭汭\footnote{text}，漆沮既从\footnote{text}，沣水攸同\footnote{text}。荆、岐既旅\footnote{text}，终南、惇物\footnote{text}，至于鸟鼠\footnote{text}。原隰厎绩\footnote{text}，至于猪野\footnote{text}。三危既宅\footnote{text}，三苗丕叙\footnote{text}。厥土惟黄壤，厥田惟上上，厥赋中下。厥贡惟球、琳、琅玕\footnote{text}。浮于积石\footnote{text}，至于龙门、西河\footnote{text}，会于渭汭\footnote{text}。织皮昆仑、析支、渠搜\footnote{text}，西戎即叙\footnote{text}。
\end{yuanwen}

黑水到西河之间是雍州：

弱水疏通已向西流，泾河流入渭河之湾，漆沮水已经会合洛水流入黄河，沣水也向北流同渭河会合。荆山、岐山治理以后，终南山、惇物山一直到鸟鼠山都得到了治理。原隰的治理取得了成绩，至于猪野泽也得到了治理。三危山已经可以居住，三苗就安定了。这里的土是黄色的，这里的田是第一等，赋税是第六等。这里的贡物是美玉、美石和珠宝。进贡的船只从积石山附近的黄河，到达龙门、西河，与从渭河逆流而上的船只会合在渭河以北。织皮的人民定居在昆仑、析支、渠搜三座山下，西戎各族就安定顺从了。

\begin{yuanwen}
导岍及岐\footnote{text}，至于荆山\footnote{text}，逾于河\footnote{text}；壶口、雷首至于太岳\footnote{text}；

厎柱、析城至于王屋\footnote{text}；太行、恒山至于碣石\footnote{text}，入于海。


西倾、朱圉、鸟鼠至于太华\footnote{text}；熊耳、外方、桐柏至于陪尾\footnote{text}。

导嶓冢，至于荆山\footnote{text}；内方，至于大别\footnote{text}。

岷山之阳，至于衡山\footnote{text}。过九江，至于敷浅原\footnote{text}。
\end{yuanwen}

开通了岍山和岐山的道路，到达荆山，越过黄河。又开通壶口山、雷首山，到达太岳山。

又开通厎柱山、析城山，到达王屋山。又开通太行山、恒山，到达碣石山，从这里进入渤海。
...
\begin{yuanwen}
导弱水至于合黎\footnote{text}，馀波入于流沙\footnote{text}。导黑水至于三危\footnote{text}，入于南海\footnote{text}。

导河、积石，至于龙门\footnote{text}；南至于华阴\footnote{text}，东至于厎柱，又东至于孟津\footnote{text}，东过洛汭\footnote{text}，至于大伾\footnote{text}；北过降水\footnote{text}，至于大陆\footnote{text}；又北，播为九河\footnote{text}，同为逆河\footnote{text}，入于海。
\end{yuanwen}
...
\begin{yuanwen}
嶓冢导漾\footnote{text}，东流为汉，又东，为沧浪之水\footnote{text}，过三澨\footnote{text}，至于大别，南入于江。东，汇泽为彭蠡\footnote{text}，东，为北江，入于海。

岷山导江，东别为沱\footnote{text}，又东至于澧\footnote{text}；过九江\footnote{text}，至于东陵\footnote{text}，东迆北\footnote{text}，会于汇；东为中江，入于海。
\end{yuanwen}
...
\begin{yuanwen}
导沇水\footnote{text}，东流为济\footnote{text}，入于河，溢为荥\footnote{text}；东出于陶丘北\footnote{text}，又东至于菏\footnote{text}，又东北，会于汶，又北，东入于海。

导淮自桐柏\footnote{text}，东会于泗、沂\footnote{text}，东入于海。
\end{yuanwen}
...
\begin{yuanwen}
导渭自鸟鼠同穴\footnote{text}，东会于沣\footnote{text}，又东会于泾\footnote{text}，又东过漆沮\footnote{text}，入于河。

导洛自熊耳\footnote{text}，东北，会于涧、瀍\footnote{text}；又东，会于伊\footnote{text}，又东北，入于河。
\end{yuanwen}
...
\begin{yuanwen}
九州攸同\footnote{text}，四隩既宅\footnote{text}，九山刊旅\footnote{text}，九川涤源\footnote{text}，九泽既陂\footnote{text}，四海会同\footnote{text}。六府孔修\footnote{text}，庶土交正\footnote{text}，厎慎财赋\footnote{text}，咸则三壤\footnote{text}。成赋中邦\footnote{text}。锡土姓\footnote{text}，祗台德先\footnote{text}，不距朕行\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
五百里甸服\footnote{text}：百里赋纳总\footnote{text}，二百里纳銍\footnote{text}，三百里纳秸服\footnote{text}，四百里粟\footnote{text}，五百里米\footnote{text}。

五百里侯服\footnote{text}：百里采\footnote{text}，二百里男邦\footnote{text}，三百里诸侯\footnote{text}。

五百里绥服\footnote{text}：三百里揆文教\footnote{text}，二百里奋武卫\footnote{text}。

五百里要服\footnote{text}：三百里夷\footnote{text}，二百里蔡\footnote{text}。

五百里荒服\footnote{text}：三百里蛮\footnote{text}，二百里流\footnote{text}。

东渐于海\footnote{text}，西被于流沙\footnote{text}，朔南暨声教\footnote{text}，讫于四海\footnote{text}。禹锡玄圭\footnote{text}，告厥成功。
\end{yuanwen}
...
\begin{yuanwen}
启与有扈战于甘之野\footnote{text}，作《甘誓》。
\end{yuanwen}

启与有扈氏将在甘这个地方进行大战，启作了一篇誓辞叫做《甘誓》。

\begin{yuanwen}
大战于甘\footnote{text}，乃召六卿\footnote{text}。
\end{yuanwen}

甘这个地方将要进行一场大规模的战争，夏王启于是召见了六军的将领。

\begin{yuanwen}
王曰\footnote{text}：“嗟\footnote{text}！六事之人\footnote{text}，予誓告汝\footnote{text}：有扈氏威侮五行\footnote{text}，怠弃三正\footnote{text}，天用剿绝其命\footnote{text}，今予惟恭行天之罚\footnote{text}。左不攻于左\footnote{text}，汝不恭命\footnote{text}；右不攻于右\footnote{text}，汝不恭命；御非其马之正\footnote{text}，汝不恭命。用命\footnote{text}，赏于祖\footnote{text}；弗用命，戮于社\footnote{text}，予则孥戮汝\footnote{text}。”
\end{yuanwen}
...
\begin{yuanwen}
太康失邦\footnote{text}，昆弟五人须于洛汭\footnote{text}，作《五子之歌》。
\end{yuanwen}

康的国家被灭了，他的兄弟五人流浪到洛汭，在该处作了《五子之歌》。

\begin{yuanwen}
太康尸位\footnote{text}，以逸豫灭厥德\footnote{text}，黎民咸贰\footnote{text}，乃盘游无度\footnote{text}，畋于有洛之表\footnote{text}，十旬弗反\footnote{text}。有穷后羿因民弗忍\footnote{text}，距于河\footnote{text}，厥弟五人御其母以从\footnote{text}，徯于洛之汭\footnote{text}。五子咸怨，述大禹之戒以作歌\footnote{text}。
\end{yuanwen}
...
\begin{yuanwen}
其一曰：“皇祖有训\footnote{text}，民可近，不可下。民惟邦本\footnote{text}，本固邦宁。予视天下愚夫愚妇，一能胜予\footnote{text}，一人三失\footnote{text}，怨岂在明\footnote{text}？不见是图\footnote{text}。予临兆民\footnote{text}，懔乎若朽索之驭六马\footnote{text}，为人上者，奈何不敬\footnote{text}？”
\end{yuanwen}
...
\begin{yuanwen}
其二曰：“训有之\footnote{text}：内作色荒\footnote{text}，外作禽荒\footnote{text}。甘酒嗜音\footnote{text}，峻宇雕墙\footnote{text}。有一于此，未或不亡\footnote{text}。”
\end{yuanwen}

其中第二首说：“训诫中有这些话：在宫中沉迷女色，在外沉迷游猎翱翔；喜欢喝酒和爱听音乐，修筑高大殿宇又雕饰宫墙。身为国君，这些事只要有一桩，国家就会灭亡。”

\begin{yuanwen}
其三曰：“惟彼陶唐\footnote{text}，有此冀方\footnote{text}。今失厥道，乱其纪纲\footnote{text}，乃厎灭亡\footnote{text}。”
\end{yuanwen}

其中第三首说：“那陶唐氏的尧皇帝，曾经据有冀州这地方。现在废弃他的治国之道，破坏了他所建立的法度，就会灭亡！”

\begin{yuanwen}
其四曰：“明明我祖\footnote{text}，万邦之君。有典有则\footnote{text}，贻厥子孙\footnote{text}。关石和钧\footnote{text}，王府则有\footnote{text}。荒坠厥绪\footnote{text}，覆宗绝祀\footnote{text}！”
\end{yuanwen}

其中第四首说：“我们英明睿智的先祖大禹，是万国之君。他建立的典章与法度，留给了后代子孙。征赋和计量平均，王家府库丰殷。现在废弃破坏这些法度，就断绝祭祀又危及宗亲！”

\begin{yuanwen}
其五曰：“呜呼！曷归\footnote{text}？予怀之悲\footnote{text}。万姓仇予\footnote{text}，予将畴依\footnote{text}？郁陶乎予心\footnote{text}，颜厚有忸怩\footnote{text}。弗慎厥德，虽悔可追\footnote{text}？”
\end{yuanwen}
...
\begin{yuanwen}
羲和湎淫\footnote{text}，废时乱日\footnote{text}，胤往征之，作《胤征\footnote{text}》。
\end{yuanwen}

夏朝时，掌管日月运行的羲和的后代沉湎于淫乱，胤前往征讨，在大战之前作了《胤征》来鼓舞士气。

\begin{yuanwen}
惟仲康肇位四海\footnote{text}，胤侯命掌六师\footnote{text}。羲和废厥职，酒荒于厥邑\footnote{text}，胤后承王命徂征\footnote{text}。
\end{yuanwen}

仲康开始登上王位统治四海时，命令胤侯为大司马掌管六军。羲氏与和氏放弃他的职守，回到自己的封地嗜酒荒乱。胤侯接受王命，去征伐羲和。

\begin{yuanwen}
告于众曰：“嗟\footnote{text}！予有众：圣有谟训\footnote{text}，明征定保\footnote{text}，先王克谨天戒\footnote{text}，臣人克有常宪\footnote{text}，百官修辅\footnote{text}，厥后惟明明\footnote{text}，每岁孟春\footnote{text}，遒人以木铎徇于路\footnote{text}，官师相规\footnote{text}，工执艺事以谏\footnote{text}，其或不恭\footnote{text}，邦有常刑\footnote{text}。惟时羲和颠覆厥德\footnote{text}，沈乱于酒\footnote{text}，畔官离次\footnote{text}，俶扰天纪\footnote{text}，遐弃厥司\footnote{text}，乃季秋月朔，辰弗集于房\footnote{text}，瞽奏鼓\footnote{text}，啬夫驰，庶人走\footnote{text}，羲和尸厥官罔闻知\footnote{text}，昏迷于天象\footnote{text}，以干先王之诛\footnote{text}，《政典》曰\footnote{text}：‘先时者杀无赦\footnote{text}，不及时者杀无赦\footnote{text}。’今予以尔有众\footnote{text}，奉将天罚\footnote{text}。尔众士同力王室\footnote{text}，尚弼予钦承天子威命\footnote{text}。火炎昆冈\footnote{text}，玉石俱焚。天吏逸德\footnote{text}，烈于猛火。歼厥渠魁\footnote{text}，胁从罔治，旧染污俗\footnote{text}，咸与维新\footnote{text}。呜呼！威克厥爱\footnote{text}，允济\footnote{text}；爱克厥威，允罔功。其尔众士懋戒哉\footnote{text}！”
\end{yuanwen}

胤侯告戒军众说：“啊！众位官长。圣人有谟有训，清楚明白的指明了定国安邦的事。先王能谨慎对待上天的警戒，大臣能遵守常法，百官修治职事辅佐君主，君主就明而又明。每年孟春之月，宣令官员用木铎在路上宣布教令，官长互相规劝，百工依据他们从事的技艺进行谏说。他们有不奉行的，国家将有常刑。“这个羲和颠倒他的行为，沉醉在酒中，背离职位，开始搞乱了日月星辰的运行历程，远远放弃他所司的事。前些时候季秋月的朔日，日月不会合于房，出现日食，乐官进鼓而击，啬夫奔驰取币以礼敬神明，众人跑着供役。羲和主管其官却不知道这件事，对天象昏迷无知，因此触犯了先王的诛罚。先王的《政典》说：历法出现先于天时的事，杀掉无赦；出现后于天时的事，杀掉无赦。“现在我率领你们众长，奉行上天的惩罚。你等众士要与王室同心协力，辅助我认真奉行天子的庄严命令！大火燃烧昆仑山时，美玉和顽石都遭到毁灭；天王的官吏如有过恶行为，害处将比猛火更甚。消灭那些为恶的大首领，协从的人不要惩治；旧时染有污秽习俗的人，都允许更新。“啊！从严治军胜过对士兵的爱惜，一定能成功；爱惜胜过从严要求，作战就不能成功。你等众士要努力戒慎呀！”
...
\begin{yuanwen}
自契至于成汤八迁\footnote{text}，汤始居亳\footnote{text}，从先王居，作《帝告》、《厘沃\footnote{text}》。
\end{yuanwen}
...
\begin{yuanwen}
汤征诸侯。葛伯不祀\footnote{text}，汤始征之，作《汤征》。
\end{yuanwen}

\chapter{汝鸠}

\begin{yuanwen}
伊尹去亳适夏\footnote{text}，既丑有夏\footnote{text}，复归于亳。入自北门\footnote{text}，乃遇汝鸠、汝方，作《汝鸠》、《汝方》。
\end{yuanwen}
...
\begin{yuanwen}
伊尹相汤伐桀\footnote{text}，升自陑\footnote{text}，遂与桀战于鸣条之野\footnote{text}，作《汤誓》。
\end{yuanwen}

伊尹辅佐商汤讨伐夏桀，队伍开拔到山西永济一带，于是与夏桀在鸣条之野展开大战。战前作动员令，即为《汤誓》。

\begin{yuanwen}
王曰\footnote{text}：“格，尔众庶\footnote{text}！悉听朕言：非台小子敢行称乱\footnote{text}。有夏多罪\footnote{text}，天命殛之\footnote{text}。今尔有众，汝曰：‘我后不恤我众\footnote{text}，舍我穑事\footnote{text}，而割正夏\footnote{text}？’予惟闻汝众言\footnote{text}，夏氏有罪，予畏上帝，不敢不正。今汝其曰\footnote{text}：‘夏罪其如台\footnote{text}？’夏王率遏众力\footnote{text}，率割夏邑\footnote{text}。有众率怠弗协\footnote{text}，曰：‘时日曷丧\footnote{text}？予及汝皆亡。’夏德若兹\footnote{text}，今朕必往。尔尚辅予一人\footnote{text}，致天之罚\footnote{text}，予其大赉汝\footnote{text}！尔无不信\footnote{text}，朕不食言。尔不从誓言，予则孥戮汝\footnote{text}，罔有攸赦\footnote{text}。”
\end{yuanwen}

王说：“来吧！诸位，都听我说。不是我小子敢行作乱！是因为夏朝犯下许多罪行，上天命令我去讨伐它。现在你们当中肯定有人会说：‘我们的君王不怜悯我们众人，荒废我们的农事，怎么还能去纠正他人呢？’我虽然理解你们的话，但是夏氏有罪，我畏惧上天，不敢不去征伐啊！现在你们会问：‘夏桀的罪行究竟怎么样呢？’夏王耗尽民力，残酷地剥削压迫自己的百姓。民众对他不满，怠慢不恭，同他的态度也不友好，他们说：‘这个太阳什么时候消失呢？我们愿意同你一起灭亡。’夏国的政治已经败坏到这种程度，现在我一定要去讨伐他。你们只需要辅助我，奉行上天对夏的惩罚，我将重重地赏赐你们！你们不要不相信，我不会说话不算话。如果你们不遵守誓言，我就会把你们降成奴隶，或者杀死你们，不会有所赦免。”

\chapter{夏社}

\begin{yuanwen}
汤既胜夏，欲迁其社\footnote{text}，不可\footnote{text}，作《夏社》、《疑至》、《臣扈》。
\end{yuanwen}
...
\begin{yuanwen}
夏师败绩\footnote{text}，汤遂从之\footnote{text}，遂伐三朡\footnote{text}，俘厥宝玉\footnote{text}，谊伯、仲伯作《典宝\footnote{text}》。
\end{yuanwen}

\chapter{仲虺之诰}

\begin{yuanwen}
汤归自夏\footnote{text}，至于大坰\footnote{text}，仲虺作诰。
\end{yuanwen}

\begin{yuanwen}
成汤放桀于南巢\footnote{text}，惟有惭德\footnote{text}。曰：“予恐来世以台为口实\footnote{text}。”
\end{yuanwen}

成汤放逐夏桀使他住在南巢，心里有些惭愧。他说：“我怕后世拿我作为话柄。”

\begin{yuanwen}
仲虺乃作诰曰：“呜呼！惟天生民有欲，无主乃乱，惟生聪明时乂\footnote{text}，有夏昏德，民坠涂炭\footnote{text}，天乃锡王勇智\footnote{text}，表正万邦\footnote{text}，缵禹旧服\footnote{text}。兹率厥典\footnote{text}，奉若天命\footnote{text}。夏王有罪，矫诬上天\footnote{text}，以布命于下\footnote{text}。帝用不臧\footnote{text}，式商受命\footnote{text}，用爽厥师\footnote{text}。简贤附势\footnote{text}，实繁有徒\footnote{text}。肇我邦于有夏\footnote{text}，若苗之有莠\footnote{text}，若粟之有秕\footnote{text}。小大战战\footnote{text}，罔不惧于非辜\footnote{text}。矧予之德言足听闻？惟王不迩声色\footnote{text}，不殖货利\footnote{text}。德懋懋官\footnote{text}，功懋懋赏。用人惟己\footnote{text}，改过不吝\footnote{text}。克宽克仁\footnote{text}，彰信兆民\footnote{text}。乃葛伯仇饷\footnote{text}，初征自葛，东征，西夷怨；南征，北狄怨，曰：‘奚独后予\footnote{text}？’攸徂之民\footnote{text}，室家相庆\footnote{text}，曰：‘徯予后\footnote{text}，后来其苏\footnote{text}。’民之戴商\footnote{text}，厥惟旧哉\footnote{text}！佑贤辅德，显忠遂良\footnote{text}，兼弱攻昧\footnote{text}，取乱侮亡\footnote{text}，推亡固存\footnote{text}，邦乃其昌。德日新，万邦惟怀\footnote{text}；志自满，九族乃离\footnote{text}。王懋昭大德\footnote{text}，建中于民\footnote{text}，以义制事\footnote{text}，以礼制心\footnote{text}，垂裕后昆\footnote{text}。予闻曰：‘能自得师者王，谓人莫己若者亡。好问则裕，自用则小’。呜呼！慎厥终\footnote{text}，惟其始\footnote{text}。殖有礼\footnote{text}，覆昏暴\footnote{text}。钦崇天道\footnote{text}，永保天命。”
\end{yuanwen}

仲虺于是向汤作了解释，说：“啊！上天生养人民，人人都有情欲，天下没有君主，人民就会乱作一团，因此上天又生出聪明的人来治理他们。夏桀行为昏乱，人民处于水深火热的困境之中；上天于是赋予勇敢和智慧给大王，让您做万国的表率，继承大禹长久的事业。您现在要遵循大禹的常法，顺从上天的大命！夏王桀有罪，他假托上天的意旨，欺骗百姓。上天因此认为他不善，要我商家承受天命，使我们教导他的众庶。慢待贤明的人，趋炎附势，这种人很多。我们国家刚开始建立时，夏桀对待我们就像对待杂草一般。老百姓和大人物都战慄恐惧，都担心自己无罪受罚；但是你不同，你是有德之人，只要说出话来，就有人信从。大王不近声色，不聚货财；德盛的人用官职劝勉他，功大的人用奖赏劝勉他；勇于采纳他人的意见，改正过错毫不吝惜；能宽能仁，昭信于万民。从前葛国国君，恩将仇报，杀掉我们前往葛国救灾的人，我们的征伐从葛国开始。大王东征时西方的人们就怨恨我们；南征时北方的人就埋怨我们。他们说：为什么把征伐我们的国君摆在后面？但凡被我们征伐的国家，百姓都在家互相庆贺。他们说：君主啊，君主来临，我们就可以兴盛了！天下人民对于商的爱戴，已经很久了！佑助贤德的诸侯，显扬忠良的诸侯；兼并懦弱的，讨伐昏暗的，夺取荒乱的，轻慢走向灭亡的。推求灭亡的道理，以巩固自己的生存，国家就将昌盛。“德行日日革新，天下万国就会怀念；志气自满自大，亲近的九族也会离散。大王要努力显扬大德，对人民建立中道，用义裁决事务，用礼制约思想，把宽裕之道传给后人。我听说能够自己求得老师的人就会为王，以为别人不及自己的人就会灭亡。爱好问，知识就充裕；只凭自己，闻见就狭小。“啊！慎终的办法，在于善谋它的开始。扶植有礼之邦，灭亡昏暴之国；敬重上天这种规律，就可以长久保持天命了。”

\chapter{汤诰}

\begin{yuanwen}
汤既黜夏命\footnote{text}，复归于亳，作《汤诰》。
\end{yuanwen}

商汤流放夏桀以后，率部队回到亳都，然后作《汤诰》训示诸侯。

\begin{yuanwen}
王归自克夏\footnote{text}，至于亳，诞告万方\footnote{text}。
\end{yuanwen}

汤王在战胜夏桀后回来，到了亳邑，大告万方诸侯。

\begin{yuanwen}
王曰：“嗟\footnote{text}！尔万方有众，明听予一人诰\footnote{text}：惟皇上帝\footnote{text}，降衷于下民\footnote{text}。若有恒性\footnote{text}，克绥厥猷惟后\footnote{text}。夏王灭德作威，以敷虐于尔万方百姓\footnote{text}。尔万方百姓罹其凶害\footnote{text}，弗忍荼毒\footnote{text}，并告无辜于上下神祇\footnote{text}。天道福善祸淫\footnote{text}，降灾于夏，以彰厥罪\footnote{text}。肆台小子将天命明威\footnote{text}，不敢赦\footnote{text}。敢用玄牡\footnote{text}，敢昭告于上天神后\footnote{text}，请罪有夏\footnote{text}。聿求元圣\footnote{text}，与之戮力\footnote{text}，以与尔有众请命\footnote{text}。上天孚佑下民\footnote{text}，罪人黜伏\footnote{text}，天命弗僭\footnote{text}，贲若草木\footnote{text}，兆民允殖\footnote{text}。俾予一人辑宁尔邦家\footnote{text}，兹朕未知获戾于上下，栗栗危惧\footnote{text}，若将陨于深渊\footnote{text}。凡我造邦\footnote{text}，无从匪彝\footnote{text}，无即慆淫\footnote{text}，各守尔典\footnote{text}，以承天休\footnote{text}。尔有善，朕弗敢蔽\footnote{text}；罪当朕躬\footnote{text}，弗敢自赦，惟简在上帝之心\footnote{text}。其尔万方有罪，在予一人；予一人有罪，无以尔万方\footnote{text}。呜呼！尚克时忱\footnote{text}，乃亦有终\footnote{text}。”
\end{yuanwen}

汤王说：“啊！众多国家的民众，请认真地听取我的命令。伟大的上天，将美好的德行降于下界人民。让民众长久的保持这种好的品德，只有君王才能够做到。夏王丧失道德滥用刑罚，对百姓施行虐政。所有的百姓都遭受这样的灾难，痛苦不堪，于是你们向上天祈求。天道福佑善人，惩罚坏人，在夏国降下灾难，来显露他的罪过。所以我奉行天命明法，不敢宽恕夏桀的罪行。敢用黑色公牛向天神后土祷告，请求惩治夏桀。于是寻求那伟大的圣人，与你们一起向上天祈求。上天相信并且保护下界的百姓，罪人夏桀被流放斥退失去天子之位，遭到应得的惩罚，上天的旨意是不会出错的，如此，整个国家都焕然一新了。上天使我和睦安定你们的国家，这回伐桀我不知道得罪了天地没有，惊恐畏惧，像要落到深渊里一样。凡我建立的诸侯，不要施行非法，不要追求安乐；要各自遵守常法，以接受上天的福禄。你们有善行，我不敢掩盖；罪过在我自身，我不敢自己宽恕，因为这些在上天心里都明明白白。你们万方有过失，原因都在于我；我有过失，绝不会让你们被牵连。哎！如果能够做到这些的话，就会获得成功。”

\chapter{明居}

\begin{yuanwen}
咎单作《明居》\footnote{text}。
\end{yuanwen}

\chapter{伊训}

\begin{yuanwen}
成汤既没\footnote{text}，太甲元年\footnote{text}，伊尹作《伊训》、《肆命》、《徂后》\footnote{text}。
\end{yuanwen}

成汤去世以后，后来太甲继承了帝位，这一年伊尹作《伊训》、《肆命》、《徂后》教导太甲。

\begin{yuanwen}
惟元祀十有二月乙丑\footnote{text}，伊尹祠于先王\footnote{text}，奉嗣王祗见厥祖\footnote{text}。侯甸群后咸在\footnote{text}。百官总已以听冢宰\footnote{text}。伊尹乃明言烈祖之成德\footnote{text}，以训于王。
\end{yuanwen}

\begin{yuanwen}
曰：“呜呼！古有夏先后方懋厥德\footnote{text}，罔有天灾\footnote{text}。山川鬼神，亦莫不宁\footnote{text}。暨鸟兽鱼鳖\footnote{text}，咸若\footnote{text}。于其子孙弗率\footnote{text}，皇天降灾\footnote{text}，假手于我有命\footnote{text}，造攻自鸣条\footnote{text}，朕哉自亳\footnote{text}。惟我商王，布昭圣武\footnote{text}，代虐以宽，兆民允怀\footnote{text}。今王嗣厥德\footnote{text}，罔不在初\footnote{text}，立爱惟亲\footnote{text}，立敬惟长\footnote{text}，始于家邦，终于四海。
\end{yuanwen}

\begin{yuanwen}
呜呼！先王肇修人纪\footnote{text}，从谏弗咈\footnote{text}，先民时若\footnote{text}。居上克明\footnote{text}，为下克忠。与人不求备\footnote{text}，检身若不及\footnote{text}，以至于有万邦\footnote{text}，兹惟艰哉\footnote{text}！
\end{yuanwen}

\begin{yuanwen}
敷求哲人\footnote{text}，俾辅于尔后嗣\footnote{text}，制官刑\footnote{text}，儆于有位\footnote{text}。
\end{yuanwen}

\begin{yuanwen}
曰：‘敢有恒舞于宫\footnote{text}，酣歌于室\footnote{text}，时谓巫风\footnote{text}；敢有殉于货色\footnote{text}，恒于游畋\footnote{text}，时谓淫风\footnote{text}。敢有侮圣言\footnote{text}，逆忠直，远耆德\footnote{text}，比顽童\footnote{text}，时谓乱风\footnote{text}。惟兹三风十愆\footnote{text}，卿士有一于身，家必丧\footnote{text}；邦君有一于身，国必亡。臣下不匡，其刑墨\footnote{text}。具训于蒙士\footnote{text}。’
\end{yuanwen}

\begin{yuanwen}
呜呼！嗣王祗厥身\footnote{text}，念哉\footnote{text}！圣谟洋洋\footnote{text}，嘉言孔彰\footnote{text}。惟上帝不常\footnote{text}：作善降之百祥，作不善降之百殃。尔惟德罔小\footnote{text}，万邦惟庆\footnote{text}；尔惟不德罔大，坠厥宗\footnote{text}。”
\end{yuanwen}
...
肆，陈。命，天命。孔氏《传》曰：“陈天命以戒大甲。”故名。正文佚，序与《伊训》、《徂后》共。

\chapter{徂后}

徂，往、去。后，君。徂后，犹言先君。盖陈先君成汤之德行，故名。郑玄曰：“言汤之法度也。”或是。正文佚，序与《伊训》、《肆命》共。
