...
\begin{document}
	...
	\begin{yuanwen}
	凡军好\footnote{hao4，喜欢。}高而恶\footnote{厌恶，讨厌。}下，贵\footnote{这里是重视的意思。}阳而贱\footnote{轻视，这里有避开的意思。}阴，养生\footnote{指据有水草之利。}而处实\footnote{指依托高地而处。}，军无百疾，是谓必胜。丘陵堤防，必处其阳而右背之。此兵之利，地之助\footnote{得到地形的辅助。}也。上雨，水沫至\footnote{银雀山竹简本《孙子兵法》作“上雨水，水流至”。“沫”字当为“流”字之误。}，欲涉\footnote{徒步趟水。}者，待其定也。
	\end{yuanwen}
